...
# get the embeddding dimension for the configured embedding model
...
# get the OpenAI embedding object
def get_embeddings():
    global _embeddings
...
def ensure_index():
    ...
    # if the index exists but has a different dimention, delete it and create a new index
...
def get_vectorstore():
    ...
    if _vectorstore is None:
        # ensure the index exits and is ready
        index = ensure_index()
...
# add all the documents to the vectorstore
